      ...
      return common_vendor.e({
        a: common_vendor.f(common_vendor.unref(utils_commonData.listTabData), (item, index2, i0) => {
          return {
            ...
            b: common_vendor.n(activeIndex.value === index2 ? "active" : ""),
            c: common_vendor.o(($event) => changeTab(index2), index2),
            d: index2
          };
        }),
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "E:/project/康乐养老/project-zhyl-xcx-uniapp-java/subPages/appointment/list/components/list.vue"]]);
